...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Action_Boolean p_default_Swipe;
        
        private static SteamVR_Action_Vector2 p_default_HeightChange;
        
        private static SteamVR_Action_Boolean p_default_ToggleLaser;
        
        private static SteamVR_Action_Boolean p_default_Togglein2visible;
        ...
        public static SteamVR_Action_Boolean default_Swipe
        {
            get
            {
                return SteamVR_Actions.p_default_Swipe.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        
        public static SteamVR_Action_Vector2 default_HeightChange
        {
            get
            {
                return SteamVR_Actions.p_default_HeightChange.GetCopy<SteamVR_Action_Vector2>();
            }
        }
        
        public static SteamVR_Action_Boolean default_ToggleLaser
        {
            get
            {
                return SteamVR_Actions.p_default_ToggleLaser.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        
        public static SteamVR_Action_Boolean default_Togglein2visible
        {
            get
            {
                return SteamVR_Actions.p_default_Togglein2visible.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        ...
        private static void InitializeActionArrays()
        {
            Valve.VR.SteamVR_Input.actions = new Valve.VR.SteamVR_Action[] {
                    ...
                    SteamVR_Actions.default_HeightChange,
                    SteamVR_Actions.default_ToggleLaser,
                    SteamVR_Actions.default_Togglein2visible,
        ...
        private static void PreInitActions()
        {
            ...
            SteamVR_Actions.p_default_Swipe = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/Swipe")));
            SteamVR_Actions.p_default_HeightChange = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/default/in/HeightChange")));
            SteamVR_Actions.p_default_ToggleLaser = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/ToggleLaser")));
            SteamVR_Actions.p_default_Togglein2visible = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/Togglein2visible")));
